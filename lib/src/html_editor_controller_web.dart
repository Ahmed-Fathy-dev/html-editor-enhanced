...
class HtmlEditorController extends unsupported.HtmlEditorController {
  ...
  void clearFocus() {
    throw Exception(
        'Flutter Web environment detected, please make sure you are importing package:html_editor_enhance/html_editor.dart and check kIsWeb before calling this method.');
  }
  ...
  void _evaluateJavascriptWeb({required Map<String, Object?> data}) async {
    if (kIsWeb) {
      ...
      throw Exception(
          'Non-Flutter Web environment detected, please make sure you are importing package:html_editor_enhance/html_editor.dart');
    }
  }
}
