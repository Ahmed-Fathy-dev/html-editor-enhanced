...
class _HtmlEditorWidgetMobileState extends State<HtmlEditorWidget> {
  ...
  void initState() {
    ...
    if (widget.htmlEditorOptions.filePath != null) {
      ...
      filePath = 'packages/html_editor_enhance/assets/summernote.html';
    }
    super.initState();
  }
                  ...
                  onLoadStop:
                    ...
                    if (url.contains(filePath)) {
                      ...
                      if ((Theme.of(context).brightness == Brightness.dark ||
                        ...
                        var darkCSS =
                            '<link href=\"${(widget.htmlEditorOptions.filePath != null ? "file:///android_asset/flutter_assets/packages/html_editor_enhance/assets/" : "") + "summernote-lite-dark.css"}\" rel=\"stylesheet\">';
                        await controller.evaluateJavascript(
