...
import 'package:html_editor_enhance/utils/utils.dart';
// ignore: avoid_web_libraries_in_flutter
import 'dart:html' as html;
import 'package:html_editor_enhance/utils/shims/dart_ui.dart' as ui;
...
class _HtmlEditorWidgetWebState extends State<HtmlEditorWidget> {
  ...
  void initSummernote() async {
    ...
    if ((Theme.of(widget.initBC).brightness == Brightness.dark ||
      ...
      darkCSS =
          '<link href=\"assets/packages/html_editor_enhance/assets/summernote-lite-dark.css\" rel=\"stylesheet\">';
    }
    var jsCallbacks = '';
    if (widget.callbacks != null) {
    ...
    """;
    var filePath =
        'packages/html_editor_enhance/assets/summernote-no-plugins.html';
    ...
    htmlString = htmlString
        ...
        .replaceFirst('"jquery.min.js"',
            '"assets/packages/html_editor_enhance/assets/jquery.min.js"')
        .replaceFirst('"summernote-lite.min.css"',
            '"assets/packages/html_editor_enhance/assets/summernote-lite.min.css"')
        .replaceFirst('"summernote-lite.min.js"',
            '"assets/packages/html_editor_enhance/assets/summernote-lite.min.js"');
        ...
        html.window.onMessage.listen((event) {
          ...
          if (data['type'] != null &&
            ...
            if (widget.htmlEditorOptions.shouldEnsureVisible) {
              //TODO: && Scrollable.of(context) != null removed
