...
import 'package:html_editor_enhance/src/html_editor_controller_unsupported.dart'
    as unsupported;
...
class HtmlEditorController extends unsupported.HtmlEditorController {
  ...
  void reloadWeb() {
    throw Exception(
        'Non-Flutter Web environment detected, please make sure you are importing package:html_editor_enhance/html_editor.dart and check kIsWeb before calling this function');
  }
  ...
  dynamic _evaluateJavascript({required source}) async {
    if (!kIsWeb) {
      ...
      throw Exception(
          'Flutter Web environment detected, please make sure you are importing package:html_editor_enhance/html_editor.dart');
    }
  }
