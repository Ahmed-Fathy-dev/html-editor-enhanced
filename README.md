...
[![pub package](https://img.shields.io/pub/v/html_editor_enhance.svg)](https://pub.dev/packages/html_editor_enhance)
...
<table>
  ...
  <tr>
    <td><img alt="GIF example" src="https://raw.githubusercontent.com/tneotia/html-editor-enhanced/master/screenshots/html_editor_enhance.gif" width="250"/></td>
...
Add `html_editor_enhance: ^2.5.0` as dependency to your pubspec.yaml.
...
For the full API reference, see [here](https://pub.dev/documentation/html_editor_enhance/latest/).
...
Every callback is defined as a `Function(<parameters in some cases>)`. See the [documentation](https://pub.dev/documentation/html_editor_enhance/latest/) for more specific details on each callback.
...
```html
<script src="assets/packages/html_editor_enhance/assets/jquery.min.js"></script>
<link href="assets/packages/html_editor_enhance/assets/summernote-lite.min.css" rel="stylesheet">
<script src="assets/packages/html_editor_enhance/assets/summernote-lite.min.js"></script>
```
...
import 'package:html_editor_enhance/html_editor.dart';
